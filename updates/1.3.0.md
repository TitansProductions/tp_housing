...
1. Added a new file (open source) for allowing developers to do adjustments when a property has been bought or lost. 

## Modified Files:
- server/tp-server_commands.lua
- server/tp-server_main.lua
- server/tp-server_escrow_ignore.lua **(ADD THIS FILE)**
- fxmanifest.lua
...
<img width="1224" height="429" alt="image" src="https://github.com/user-attachments/assets/2984f5aa-33af-4a11-818b-70c812907914" />

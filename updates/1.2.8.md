...
1. Fixed an issue that could occur in some specific doors - most likely when a property has many double doors and doors in general (as mansions do have). This would not allow the system to load the doors properly because of the coords and their hashes.
